...
data.frame( RMSE = RMSE( testing_dataset $ headcirc, predictions1),
            R2 = R2(testing_dataset $ headcirc, predictions1 ),
            MAE = MAE( testing_dataset $ headcirc, predictions1 ))

# Evaluar el rendimiento del modelo
postResample(predictions1, testing_dataset$headcirc)
